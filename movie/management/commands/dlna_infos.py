...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--renderers", action="store_true", help="discover renderers"
        )
        parser.add_argument(
            "--mediaservers", action="store_true", help="discover media servers"
        )
        parser.add_argument(
            "--contents",
            default=None,
    ...
    def handle(self, *args, **options):
        ...
        if (
            options["discover"]
            or options["smart_discover"]
            or options["renderers"]
            or options["mediaservers"]
        ):
