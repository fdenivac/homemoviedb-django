...
def smartsize(value):
    ...
    if value > 1000 * 1000 * 1000 * 1000:
        return "%.2f T%s" % (value / (1000 * 1000 * 1000 * 1000.0), unit)
    if value > 1000 * 1000 * 1000:
        return "%.2f G%s" % (value / (1000 * 1000 * 1000.0), unit)
    if value > 1000 * 1000:
        return "%.2f M%s" % (value / (1000 * 1000.0), unit)
    if value > 1000:
        return "%.2f K%s" % (value / (1000.0), unit)
